...
<!--         </header> -->
        ...
        <section class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <img src="images/ui.jpeg" alt="" class="w-100 about1">
                </div>
                <div class="col-md-9"> 
                    <h3>
                        UI/UX
                    ...
                    <p>
                        UI/UX design is a crucial aspect of creating products that provide a seamless and enjoyable experience for users. UI (User Interface) design focuses on the visual and interactive aspects of a product, such as the layout, typography, and color scheme, to create an aesthetically pleasing and user-friendly interface.
                        UX (User Experience) design, on the other hand, is concerned with the overall experience a user has when interacting with a product, including the user's journey, emotions, and behaviors.
                    </p>
                    <p>
                        Skills required for UI/UX designers:
                            UI designers need to have skills in visual design, interaction design, and front-end development.
                            UX designers need to have skills in user research, user testing, and interaction design.
                            Both UI and UX designers need to have strong communication and collaboration skills to work effectively with other team members.
